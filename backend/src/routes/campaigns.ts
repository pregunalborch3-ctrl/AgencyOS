...
import { generateCampaign, saveCampaign, getCampaigns, deleteCampaign, generateCalendar } from '../controllers/campaignController'
...
router.post('/generate-calendar',  requireAuth, generateCalendar)
